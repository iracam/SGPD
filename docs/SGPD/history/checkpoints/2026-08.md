# Checkpoint arquivado — 2026-07-30 a 2026-08-04

Registro cronológico imutável das entregas e homologações do período, retirado
de `../../CHECKPOINT.md` em 2026-08-05. Retoma onde `2026-07.md` parou.

O estado vigente do projeto **não** está aqui: está em `../../CHECKPOINT.md`.
Este arquivo serve a investigação, regressão, auditoria e rastreabilidade — o
que foi exercido, com que número, contra qual defeito e por qual decisão.

Fatos que continuam valendo foram normalizados nos documentos canônicos antes
do arquivamento: o que o sistema faz está em `CHECKPOINT.md` (*Baseline
implementado*, *Estado corrente*), o porquê das decisões em `DECISIONS.md`, a
postura de segurança em `SECURITY.md` e os resíduos abertos em
`CHECKPOINT.md` (*Riscos e pendências relevantes*) e `RISK_REGISTER.md`.

...
| R34 | Runtime HTMX local ficar desatualizado ou divergir da origem oficial | Baixa | Médio | Versão fixa 2.0.10, licença local, hash verificado na incorporação, testes da cascata e revisão explícita antes de atualizar |
